...
namespace Tools\GeneratorBundle\Command;

use Tools\GeneratorBundle\Generator\DoctrineCrudGenerator;
use Tools\GeneratorBundle\Generator\DoctrineFormGenerator;
    ...
    protected function configure()
    {
        $this
            ->setDefinition(array(
                ...
                new InputOption('is-admin', '', InputOption::VALUE_NONE, 'For Admin or Front'),
            ))
...
Using the --is-admin options tell whether it is for Admin or Front-End

<info>php app/console doctrine:mongodb:generate:crud --document=AcmeBlogBundle:Post --route-prefix=post_admin --with-write --is-admin</info>
EOT
            )
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $generator->generate($bundle, $document, $metadata, $format, $prefix, $withWrite, $isAdmin);
    ...
    private function askForDocument(InputInterface $input, OutputInterface $output, QuestionHelper $dialog)
    {
        ...
        $question->setValidator(array(
            'Tools\GeneratorBundle\Command\Validators',
