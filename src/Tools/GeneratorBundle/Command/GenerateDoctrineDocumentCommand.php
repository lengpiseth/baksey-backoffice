...
use Tools\GeneratorBundle\Generator\DoctrineDocumentGenerator;
...
class GenerateDoctrineDocumentCommand extends GenerateDoctrineCommand
{
    ...
    /**
     * @param DoctrineDocumentGenerator $generator
     */
...
EOT
     ...
     * @return int|null When the bundle doesn't end with Bundle (Example: "Bundle/MySampleBundle")
     */
