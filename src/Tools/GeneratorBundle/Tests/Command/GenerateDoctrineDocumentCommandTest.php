...
namespace Tools\GeneratorBundle\Tests\Command;

use Tools\GeneratorBundle\Command\GenerateDoctrineDocumentCommand;
...
class GenerateDoctrineDocumentCommandTest extends GenerateCommandTest
{
    ...
    protected function getGenerator()
    {
        ...
        return $this
            ->getMockBuilder('Tools\GeneratorBundle\Generator\DoctrineDocumentGenerator')
